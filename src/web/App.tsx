  ...
  return <>
    ...
    <section className="process-layout">
      <div className="setup-panel">
        ...
        {batch?.nextSearchDate && ['ANALIZANDO', 'INTERRUMPIDO'].includes(batch.status) && <p className="cursor-note"><Icon name="arrow" size={15}/>Siguiente fecha de búsqueda: {formatDate(batch.nextSearchDate)}</p>}
